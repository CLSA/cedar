...
-- Tue 12 Jan 2016 10:35:31 AM EST
...
CREATE TABLE IF NOT EXISTS `cedar`.`recording` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_test_id` (`test_id` ASC),
  UNIQUE INDEX `uq_visit_participant_id_test_id` (`participant_id` ASC, `test_id` ASC),
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cedar`.`assignment_total` (`assignment_id` INT, `deferred` INT, `completed` INT);
