...
namespace cedar\service\mat_data;
...
class module extends \cenozo\service\site_restricted_participant_module
{
  ...
  public function validate()
  {
    ...
    if( 300 > $this->get_status()->get_code() )
    {
      ...
      $db_mat_data = $this->get_resource();
      if( 'typist' == $db_role->name && !is_null( $db_mat_data ) )
      {
        $db_transcription = $db_mat_data->get_test_entry()->get_transcription();
