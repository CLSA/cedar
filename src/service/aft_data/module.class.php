...
class module extends \cenozo\service\site_restricted_participant_module
{
  ...
  public function validate()
  {
    ...
    if( 300 > $this->get_status()->get_code() )
    {
      ...
      $db_aft_data = $this->get_resource();
      if( 'typist' == $db_role->name && !is_null( $db_aft_data ) )
      {
        $db_transcription = $db_aft_data->get_test_entry()->get_transcription();
  ...
  public function prepare_read( $select, $modifier )
  {
    ...
    $modifier->join( 'test_entry', 'aft_data.test_entry_id', 'test_entry.id' );
