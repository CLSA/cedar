CREATE TABLE rey_data (
  ...
  drum_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  curtain TINYINT(1) NULL DEFAULT NULL,
  curtain_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  bell TINYINT(1) NULL DEFAULT NULL,
  bell_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  coffee TINYINT(1) NULL DEFAULT NULL,
  coffee_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  school TINYINT(1) NULL DEFAULT NULL,
  school_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  parent TINYINT(1) NULL DEFAULT NULL,
  parent_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  moon TINYINT(1) NULL DEFAULT NULL,
  moon_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  garden TINYINT(1) NULL DEFAULT NULL,
  garden_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  hat TINYINT(1) NULL DEFAULT NULL,
  hat_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  farmer TINYINT(1) NULL DEFAULT NULL,
  farmer_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  nose TINYINT(1) NULL DEFAULT NULL,
  nose_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  turkey TINYINT(1) NULL DEFAULT NULL,
  turkey_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  colour TINYINT(1) NULL DEFAULT NULL,
  colour_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  house TINYINT(1) NULL DEFAULT NULL,
  house_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  river TINYINT(1) NULL DEFAULT NULL,
  river_rey_data_variant_id INT(10) UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (id),
