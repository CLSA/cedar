...
-- Tue 03 Jan 2017 12:10:51 PM EST
...
-- -----------------------------------------------------
-- Table `cedar`.`sound_file_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`sound_file_type` ;

CREATE TABLE IF NOT EXISTS `cedar`.`sound_file_type` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `name` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cedar`.`sound_file` (
  ...
  CONSTRAINT `fk_sound_file_sound_file_type_id`
    ...
    REFERENCES `cedar`.`sound_file_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
