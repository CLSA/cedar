...
-- Wed 19 Apr 2017 05:28:22 PM EDT
...
CREATE TABLE IF NOT EXISTS `cedar`.`sound_file` (
  ...
  INDEX `fk_test_type_id1_idx` (`test_type_id` ASC),
...
-- -----------------------------------------------------
-- Table `cedar`.`word_test_entry_total`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`word_test_entry_total` ;

CREATE TABLE IF NOT EXISTS `cedar`.`word_test_entry_total` (
  `word_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `total` INT UNSIGNED NOT NULL DEFAULT 0,
...
-- -----------------------------------------------------
-- procedure update_word_test_entry_total
-- -----------------------------------------------------

USE `cedar`;
DROP procedure IF EXISTS `cedar`.`update_word_test_entry_total`;
