...
-- Tue 03 Jan 2017 03:56:53 PM EST
...
-- -----------------------------------------------------
-- Table `cedar`.`test_type_filename_format`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`test_type_filename_format` ;

CREATE TABLE IF NOT EXISTS `cedar`.`test_type_filename_format` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `test_type_id` INT UNSIGNED NOT NULL,
