...
-- Tue 05 Dec 2017 11:03:25 AM EST
...
-- -----------------------------------------------------
-- Table `cenozo`.`enrollment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenozo`.`enrollment` ;

CREATE TABLE IF NOT EXISTS `cenozo`.`enrollment` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `name` VARCHAR(100) NOT NULL,
...
-- -----------------------------------------------------
-- procedure remove_duplicate_holds
-- -----------------------------------------------------

USE `cenozo`;
DROP procedure IF EXISTS `cenozo`.`remove_duplicate_holds`;
