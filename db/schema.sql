...
-- Fri 16 Dec 2016 02:26:24 PM EST
...
-- -----------------------------------------------------
-- Table `cedar`.`test_entry_action`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`test_entry_action` ;

CREATE TABLE IF NOT EXISTS `cedar`.`test_entry_action` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `test_entry_id` INT UNSIGNED NOT NULL,
