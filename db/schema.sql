...
-- Tue 29 Nov 2016 04:44:53 PM EST
...
CREATE TABLE IF NOT EXISTS `cedar`.`test_entry` (
  ...
  `deferred` ENUM('requested','pending','resolved') NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `cedar`.`sound_file` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_test_id` (`test_id` ASC),
  UNIQUE INDEX `uq_participant_id_test_id` (`participant_id` ASC, `test_id` ASC),
  ...
  CONSTRAINT `fk_sound_file_participant_id`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sound_file_test_id`
    FOREIGN KEY (`test_id`)
    REFERENCES `cedar`.`test` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `cedar`.`cohort_event_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`cohort_event_type` ;

CREATE TABLE IF NOT EXISTS `cedar`.`cohort_event_type` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `cohort_id` INT UNSIGNED NOT NULL,
