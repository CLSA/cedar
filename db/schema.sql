...
-- Wed 22 Jan 2020 03:58:35 PM EST
-- Model: Cedar    Version: 1.0
...
CREATE TABLE IF NOT EXISTS `cenozo`.`participant` (
  ...
  `withdraw_third_party` TINYINT(1) NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`transcription`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`transcription` ;

CREATE TABLE IF NOT EXISTS `cedar`.`transcription` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- Table `cedar`.`service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`service` ;

CREATE TABLE IF NOT EXISTS `cedar`.`service` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`writelog`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`writelog` ;

CREATE TABLE IF NOT EXISTS `cedar`.`writelog` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT UNSIGNED NOT NULL,
  `site_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`role_has_service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`role_has_service` ;

CREATE TABLE IF NOT EXISTS `cedar`.`role_has_service` (
  `role_id` INT UNSIGNED NOT NULL,
...
-- Table `cedar`.`access`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`access` ;

CREATE TABLE IF NOT EXISTS `cedar`.`access` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `user_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`sound_file`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`sound_file` ;

CREATE TABLE IF NOT EXISTS `cedar`.`sound_file` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `participant_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`user_has_language`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`user_has_language` ;

CREATE TABLE IF NOT EXISTS `cedar`.`user_has_language` (
  `user_id` INT UNSIGNED NOT NULL,
  `language_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`participant_sound_file_total`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`participant_sound_file_total` ;

CREATE TABLE IF NOT EXISTS `cedar`.`participant_sound_file_total` (
  `participant_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`transcription_has_language`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`transcription_has_language` ;

CREATE TABLE IF NOT EXISTS `cedar`.`transcription_has_language` (
  ...
  CONSTRAINT `fk_transcription_has_language_transcription_id`
    ...
    REFERENCES `cedar`.`transcription` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `cedar`.`status_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`status_type` ;

CREATE TABLE IF NOT EXISTS `cedar`.`status_type` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cedar`.`test_entry` (
  ...
  `audio_status_type_id` INT UNSIGNED NULL DEFAULT NULL,
  `audio_status_other` VARCHAR(127) NULL DEFAULT NULL,
  `participant_status_type_id` INT UNSIGNED NULL DEFAULT NULL,
  `admin_status_other` VARCHAR(127) NULL DEFAULT NULL,
  `admin_status_type_id` INT UNSIGNED NULL DEFAULT NULL,
  `participant_status_other` VARCHAR(127) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_transcription_id` (`transcription_id` ASC),
  INDEX `fk_test_type_id` (`test_type_id` ASC),
  ...
  CONSTRAINT `fk_test_entry_participant_status_type_id`
    ...
    REFERENCES `cedar`.`status_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `cedar`.`test_entry_activity`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`test_entry_activity` ;

CREATE TABLE IF NOT EXISTS `cedar`.`test_entry_activity` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `test_entry_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`filename_format`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`filename_format` ;

CREATE TABLE IF NOT EXISTS `cedar`.`filename_format` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `test_type_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cedar`.`word` (
  ...
  `create_timestamp` TIMESTAMP NOT NULL,
  `language_id` INT UNSIGNED NOT NULL,
  `word` VARCHAR(65) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`rey_data_variant`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`rey_data_variant` ;

CREATE TABLE IF NOT EXISTS `cedar`.`rey_data_variant` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`rey_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`rey_data` ;

CREATE TABLE IF NOT EXISTS `cedar`.`rey_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `test_entry_id` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_rey_data_drum_rey_data_variant_id`
    ...
    REFERENCES `cedar`.`rey_data_variant` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `cedar`.`rey_data_has_word`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`rey_data_has_word` ;

CREATE TABLE IF NOT EXISTS `cedar`.`rey_data_has_word` (
...
-- -----------------------------------------------------
-- Table `cedar`.`mat_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`mat_data` ;

CREATE TABLE IF NOT EXISTS `cedar`.`mat_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `test_entry_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`premat_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`premat_data` ;

CREATE TABLE IF NOT EXISTS `cedar`.`premat_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `test_entry_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`fas_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`fas_data` ;

CREATE TABLE IF NOT EXISTS `cedar`.`fas_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `test_entry_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`aft_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`aft_data` ;

CREATE TABLE IF NOT EXISTS `cedar`.`aft_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `test_entry_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`test_type_has_cohort`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`test_type_has_cohort` ;

CREATE TABLE IF NOT EXISTS `cedar`.`test_type_has_cohort` (
  `cohort_id` INT UNSIGNED NOT NULL,
  `test_type_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`homophone`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`homophone` ;

CREATE TABLE IF NOT EXISTS `cedar`.`homophone` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`special_letter`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`special_letter` ;

CREATE TABLE IF NOT EXISTS `cedar`.`special_letter` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `language_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`transcription_has_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`transcription_has_user` ;

CREATE TABLE IF NOT EXISTS `cedar`.`transcription_has_user` (
  `transcription_id` INT UNSIGNED NOT NULL,
  `user_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`test_entry_has_word`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`test_entry_has_word` ;

CREATE TABLE IF NOT EXISTS `cedar`.`test_entry_has_word` (
  `test_entry_id` INT UNSIGNED NOT NULL,
  `word_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`word_test_type_total`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`word_test_type_total` ;

CREATE TABLE IF NOT EXISTS `cedar`.`word_test_type_total` (
  `word_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`compound`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`compound` ;

CREATE TABLE IF NOT EXISTS `cedar`.`compound` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `word_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`test_type_has_status_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`test_type_has_status_type` ;

CREATE TABLE IF NOT EXISTS `cedar`.`test_type_has_status_type` (
  `test_type_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- procedure update_participant_sound_file_total
-- -----------------------------------------------------

USE `cedar`;
DROP procedure IF EXISTS `cedar`.`update_participant_sound_file_total`;
...
-- -----------------------------------------------------
-- procedure update_transcription_has_language
-- -----------------------------------------------------

USE `cedar`;
DROP procedure IF EXISTS `cedar`.`update_transcription_has_language`;
...
-- -----------------------------------------------------
-- procedure update_transcription_has_user
-- -----------------------------------------------------

USE `cedar`;
DROP procedure IF EXISTS `cedar`.`update_transcription_has_user`;
...
-- -----------------------------------------------------
-- procedure update_test_entry_has_word
-- -----------------------------------------------------

USE `cedar`;
DROP procedure IF EXISTS `cedar`.`update_test_entry_has_word`;
...
BEGIN
  ...
  ELSEIF "rey" = @data_type THEN
    INSERT INTO test_entry_has_word( test_entry_id, word_id )
    SELECT DISTINCT proc_test_entry_id, word_id
    FROM fas_data_has_word
    JOIN fas_data ON fas_data_has_word.fas_data_id = fas_data.id
    WHERE fas_data.test_entry_id = proc_test_entry_id;
  END IF;
...
-- -----------------------------------------------------
-- procedure update_word_test_type_total
-- -----------------------------------------------------

USE `cedar`;
DROP procedure IF EXISTS `cedar`.`update_word_test_type_total`;
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`transcription_AFTER_UPDATE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`transcription_AFTER_UPDATE` AFTER UPDATE ON `transcription` FOR EACH ROW
BEGIN
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`sound_file_AFTER_INSERT` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`sound_file_AFTER_INSERT` AFTER INSERT ON `sound_file` FOR EACH ROW
BEGIN
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`sound_file_AFTER_UPDATE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`sound_file_AFTER_UPDATE` AFTER UPDATE ON `sound_file` FOR EACH ROW
BEGIN
  CALL update_participant_sound_file_total( NEW.participant_id );
END$$
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`sound_file_AFTER_DELETE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`sound_file_AFTER_DELETE` AFTER DELETE ON `sound_file` FOR EACH ROW
BEGIN
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`test_entry_AFTER_UPDATE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`test_entry_AFTER_UPDATE` AFTER UPDATE ON `test_entry` FOR EACH ROW
BEGIN
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`test_entry_has_language_AFTER_INSERT` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`test_entry_has_language_AFTER_INSERT` AFTER INSERT ON `test_entry_has_language` FOR EACH ROW
BEGIN
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`test_entry_has_language_AFTER_UPDATE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`test_entry_has_language_AFTER_UPDATE` AFTER UPDATE ON `test_entry_has_language` FOR EACH ROW
BEGIN
  SET @transcription_id = ( SELECT transcription_id FROM test_entry WHERE id = NEW.test_entry_id );
  CALL update_transcription_has_language( @transcription_id );
END$$
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`test_entry_has_language_AFTER_DELETE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`test_entry_has_language_AFTER_DELETE` AFTER DELETE ON `test_entry_has_language` FOR EACH ROW
BEGIN
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`test_entry_activity_AFTER_INSERT` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`test_entry_activity_AFTER_INSERT` AFTER INSERT ON `test_entry_activity` FOR EACH ROW
BEGIN
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`test_entry_activity_AFTER_UPDATE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`test_entry_activity_AFTER_UPDATE` AFTER UPDATE ON `test_entry_activity` FOR EACH ROW
BEGIN
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`test_entry_activity_AFTER_DELETE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`test_entry_activity_AFTER_DELETE` AFTER DELETE ON `test_entry_activity` FOR EACH ROW
BEGIN
  SET @transcription_id = (
    SELECT transcription_id
    FROM test_entry
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`word_AFTER_INSERT` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`word_AFTER_INSERT` AFTER INSERT ON `word` FOR EACH ROW
BEGIN
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`word_BEFORE_UPDATE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`word_BEFORE_UPDATE` BEFORE UPDATE ON `word` FOR EACH ROW
BEGIN
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`rey_data_has_word_AFTER_INSERT` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`rey_data_has_word_AFTER_INSERT` AFTER INSERT ON `rey_data_has_word` FOR EACH ROW
BEGIN
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`rey_data_has_word_AFTER_UPDATE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`rey_data_has_word_AFTER_UPDATE` AFTER UPDATE ON `rey_data_has_word` FOR EACH ROW
BEGIN
  SET @test_entry_id = ( SELECT test_entry_id FROM rey_data WHERE id = NEW.rey_data_id );
  CALL update_test_entry_has_word( @test_entry_id );
END$$
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`rey_data_has_word_AFTER_DELETE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`rey_data_has_word_AFTER_DELETE` AFTER DELETE ON `rey_data_has_word` FOR EACH ROW
BEGIN
  SET @test = (
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`fas_data_AFTER_INSERT` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`fas_data_AFTER_INSERT` AFTER INSERT ON `fas_data` FOR EACH ROW
BEGIN
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`fas_data_AFTER_UPDATE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`fas_data_AFTER_UPDATE` AFTER UPDATE ON `fas_data` FOR EACH ROW
BEGIN
  CALL update_test_entry_has_word( NEW.test_entry_id );
END$$
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`fas_data_AFTER_DELETE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`fas_data_AFTER_DELETE` AFTER DELETE ON `fas_data` FOR EACH ROW
BEGIN
  SET @test = (
    SELECT SUM( total ) FROM (
      SELECT COUNT(*) AS total FROM aft_data WHERE word_id = OLD.word_id UNION
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`aft_data_AFTER_INSERT` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`aft_data_AFTER_INSERT` AFTER INSERT ON `aft_data` FOR EACH ROW
BEGIN
  CALL update_test_entry_has_word( NEW.test_entry_id );
END$$
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`aft_data_AFTER_UPDATE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`aft_data_AFTER_UPDATE` AFTER UPDATE ON `aft_data` FOR EACH ROW
BEGIN
  CALL update_test_entry_has_word( NEW.test_entry_id );
END$$
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`aft_data_AFTER_DELETE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`aft_data_AFTER_DELETE` AFTER DELETE ON `aft_data` FOR EACH ROW
BEGIN
  SET @test = (
    SELECT SUM( total ) FROM (
      SELECT COUNT(*) AS total FROM aft_data WHERE word_id = OLD.word_id UNION
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`test_entry_has_word_AFTER_INSERT` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`test_entry_has_word_AFTER_INSERT` AFTER INSERT ON `test_entry_has_word` FOR EACH ROW
BEGIN
  SET @data_type = (
    SELECT test_type.data_type
    FROM test_entry
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`test_entry_has_word_AFTER_UPDATE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`test_entry_has_word_AFTER_UPDATE` AFTER UPDATE ON `test_entry_has_word` FOR EACH ROW
BEGIN
  SET @data_type = (
    SELECT test_type.data_type
    FROM test_entry
...
USE `cedar`$$
DROP TRIGGER IF EXISTS `cedar`.`test_entry_has_word_AFTER_DELETE` $$
USE `cedar`$$
CREATE DEFINER = CURRENT_USER TRIGGER `cedar`.`test_entry_has_word_AFTER_DELETE` AFTER DELETE ON `test_entry_has_word` FOR EACH ROW
BEGIN
  SET @data_type = (
    SELECT test_type.data_type
    FROM test_entry
