...
-- Thu 05 Jan 2017 04:47:40 PM EST
...
-- -----------------------------------------------------
-- Table `cedar`.`rey1_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`rey1_data` ;

CREATE TABLE IF NOT EXISTS `cedar`.`rey1_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `test_entry_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`rey2_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`rey2_data` ;

CREATE TABLE IF NOT EXISTS `cedar`.`rey2_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `test_entry_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cedar`.`defer_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cedar`.`defer_type` ;

CREATE TABLE IF NOT EXISTS `cedar`.`defer_type` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `test_type_id` INT UNSIGNED NOT NULL,
