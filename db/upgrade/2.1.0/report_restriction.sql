    ...
    SET @sql = CONCAT(
      ...
      "FROM ", @cenozo, ".report_type, ( ",
        ...
        "UNION SELECT ",
          ...
          "NULL AS operator, ",
          "NULL AS enum_list, ",
          "'Restrict to a particular cohort.' AS description ",
        "UNION SELECT ",
          "3 AS rank, ",
          "'site' AS name, ",
          "'Site' AS title, ",
        ...
        "UNION SELECT ",
          ...
          "'date' AS type, ",
          "0 AS custom, ",
          "'transcription.start_datetime' AS subject, ",
          "'>=' AS operator, ",
          "NULL AS enum_list, ",
          "'Interview recordings made on or after the given date.' AS description ",
        "UNION SELECT ",
          "5 AS rank, ",
          "'end_date' AS name, ",
          "'End Date' AS title, ",
          ...
          "'<=' AS operator, ",
          "NULL AS enum_list, ",
          "'Interview recordings made on or before the given date.' AS description ",
      ") AS restriction ",
      "WHERE report_type.name = 'quality_control'" );
