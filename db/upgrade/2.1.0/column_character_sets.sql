DROP PROCEDURE IF EXISTS repair_column_character_sets;
DELIMITER //
CREATE PROCEDURE repair_column_character_sets()
  BEGIN
...
CALL repair_column_character_sets();
DROP PROCEDURE IF EXISTS repair_column_character_sets;
