SELECT "Creating new test_type_filename_format table" AS "";

CREATE TABLE IF NOT EXISTS test_type_filename_format (
  ...
  CONSTRAINT fk_test_type_filename_format_test_type_id
