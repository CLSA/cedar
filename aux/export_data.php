      ...
      foreach( $test_type_list as $test_type )
      {
        ...
        if( 'rey' == $test_type['type'] )
        {
          ...
          $result = $this->db->query( sprintf(
            ...
            'LEFT JOIN rey_data_variant AS drum_variant ON rey_data.drum_rey_data_variant_id = drum_variant.id '.
            'LEFT JOIN word AS drum ON drum_variant.word_id = drum.id '.
            'LEFT JOIN rey_data_variant AS curtain_variant ON rey_data.curtain_rey_data_variant_id = curtain_variant.id '.
            'LEFT JOIN word AS curtain ON curtain_variant.word_id = curtain.id '.
            'LEFT JOIN rey_data_variant AS bell_variant ON rey_data.bell_rey_data_variant_id = bell_variant.id '.
            'LEFT JOIN word AS bell ON bell_variant.word_id = bell.id '.
            'LEFT JOIN rey_data_variant AS coffee_variant ON rey_data.coffee_rey_data_variant_id = coffee_variant.id '.
            'LEFT JOIN word AS coffee ON coffee_variant.word_id = coffee.id '.
            'LEFT JOIN rey_data_variant AS school_variant ON rey_data.school_rey_data_variant_id = school_variant.id '.
            'LEFT JOIN word AS school ON school_variant.word_id = school.id '.
            'LEFT JOIN rey_data_variant AS parent_variant ON rey_data.parent_rey_data_variant_id = parent_variant.id '.
            'LEFT JOIN word AS parent ON parent_variant.word_id = parent.id '.
            'LEFT JOIN rey_data_variant AS moon_variant ON rey_data.moon_rey_data_variant_id = moon_variant.id '.
            'LEFT JOIN word AS moon ON moon_variant.word_id = moon.id '.
            'LEFT JOIN rey_data_variant AS garden_variant ON rey_data.garden_rey_data_variant_id = garden_variant.id '.
            'LEFT JOIN word AS garden ON garden_variant.word_id = garden.id '.
            'LEFT JOIN rey_data_variant AS hat_variant ON rey_data.hat_rey_data_variant_id = hat_variant.id '.
            'LEFT JOIN word AS hat ON hat_variant.word_id = hat.id '.
            'LEFT JOIN rey_data_variant AS farmer_variant ON rey_data.farmer_rey_data_variant_id = farmer_variant.id '.
            'LEFT JOIN word AS farmer ON farmer_variant.word_id = farmer.id '.
            'LEFT JOIN rey_data_variant AS nose_variant ON rey_data.nose_rey_data_variant_id = nose_variant.id '.
            'LEFT JOIN word AS nose ON nose_variant.word_id = nose.id '.
            'LEFT JOIN rey_data_variant AS turkey_variant ON rey_data.turkey_rey_data_variant_id = turkey_variant.id '.
            'LEFT JOIN word AS turkey ON turkey_variant.word_id = turkey.id '.
            'LEFT JOIN rey_data_variant AS colour_variant ON rey_data.colour_rey_data_variant_id = colour_variant.id '.
            'LEFT JOIN word AS colour ON colour_variant.word_id = colour.id '.
            'LEFT JOIN rey_data_variant AS house_variant ON rey_data.house_rey_data_variant_id = house_variant.id '.
            'LEFT JOIN word AS house ON house_variant.word_id = house.id '.
            'LEFT JOIN rey_data_variant AS river_variant ON rey_data.river_rey_data_variant_id = river_variant.id '.
            'LEFT JOIN word AS river ON river_variant.word_id = river.id '.
            'WHERE cohort.name = "%s" '.
            'AND test_type.name = "%s" '.
